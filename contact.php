...
<head>
  ...
  <style>
    <?php include 'style.css'; ?><?php include 'contact.css'; ?>
  </style>
...
<body>
  ...
  <div class="contact">
    <h1>Contact Me</h1>
    <div class="icons">
      <a href="https://www.linkedin.com/in/raviranjan-09om"><i class="fab fa-linkedin"></i></a>
      <a href="https://www.instagram.com/draconianravi"><i class="fab fa-instagram"></i></a>
      <a href="https://github.com/raviranjan2001om"><i class="fab fa-github"></i></a>
      <a href="https://www.twitter.com/Raviranjankr_09"><i class="fab fa-twitter"></i></a>
    </div>
  </div>
  <footer><small>&copy; Copyright 2022, Raviranjan Kumar</small></footer>
</body>
